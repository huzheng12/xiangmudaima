...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$axios.get("/vues/getcar", { params: { usename: we } }).then(res => {
        ...
        methods: {
            ...
            asdf(qqw) {
                this.$axios.post("/vues/cartJoinjiajia", qqw).then(res => {
                    // console.log(res)
                })
                // console.log(111111)
            },
            ...
            shanchu(i) {
                ...
                this.$axios.post("/vues/cartJoinsanchu", this.att[i]).then(res => {
                    // console.log(res)
                })
                // console.log(i)
